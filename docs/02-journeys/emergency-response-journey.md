...
## Purpose
This specification is the source of truth for **Emergency Response Journey** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions
Map actor, entry point, consent, decision points, recoverable failures, support handoff, and completion. No journey may assume users have constant connectivity or English fluency.
