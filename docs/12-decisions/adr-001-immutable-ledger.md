# Adr 001 Immutable Ledger

## Purpose
This specification is the source of truth for **Adr 001 Immutable Ledger** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.
