...
This specification is the source of truth for **Assumptions And Validation** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions

Set measurable product boundaries, mobile-first Bangla/English usability, transparent fees, and explicit validation owners. Product changes must preserve donor confidence and beneficiary dignity.
