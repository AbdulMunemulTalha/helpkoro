...
## Purpose
This specification is the source of truth for **Analytics Event Taxonomy** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions
Classify sensitive data, minimize collection, version analytics events, prevent sensitive-content leakage, govern access, and reconcile financial reporting to the ledger.
