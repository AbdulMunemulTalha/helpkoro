...
This specification is the source of truth for **Tax And Receipts** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.
