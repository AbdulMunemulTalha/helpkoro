# Adr 003 Risk Based Review

## Purpose

This specification is the source of truth for **Adr 003 Risk Based Review** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions

Record the context, decision, alternatives, consequences, owner, and review trigger. Approved ADRs override lower-level documentation.
