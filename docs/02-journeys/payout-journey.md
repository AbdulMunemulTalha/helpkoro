...
This specification is the source of truth for **Payout Journey** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.
