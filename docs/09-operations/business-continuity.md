...
## Purpose
This specification is the source of truth for **Business Continuity** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions
Define owned queues, service targets, escalation, dual control for finance, secure support verification, and tested incident/continuity recovery.
