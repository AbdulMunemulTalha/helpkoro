# Trust And Safety Charter

## Purpose
This specification is the source of truth for **Trust And Safety Charter** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions
Use explainable risk triage plus trained human review for high-impact actions. Preserve evidence, provide proportional enforcement and appeal, and prioritise immediate harm reports.
