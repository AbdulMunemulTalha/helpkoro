...
This specification is the source of truth for **Cross Border Fundraising** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions

Define campaign evidence, beneficiary relationship, review rules, allowed claims, fund-use reporting, payout holds, and closure. Never make a verification label broader than what was actually checked.
