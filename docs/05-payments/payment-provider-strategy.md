...
This specification is the source of truth for **Payment Provider Strategy** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions

Separate authorization, capture, settlement, available balance, payout, refund, and dispute. Reconcile provider and ledger references daily; require maker-checker control for payout exceptions.
