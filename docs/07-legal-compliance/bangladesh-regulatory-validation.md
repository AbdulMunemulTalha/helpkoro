# Bangladesh Regulatory Validation

## Purpose

This specification is the source of truth for **Bangladesh Regulatory Validation** in HelpKoro's Bangladesh-first fundraising platform. It defines the product decision, engineering boundary, and operational ownership needed before release.

## Requirements and decisions

Every Bangladesh legal, tax, KYC/AML, charity, payment, consumer, data, or cross-border statement is a **Validate** item pending qualified counsel and provider confirmation; do not present it as fact.
